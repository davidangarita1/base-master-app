...
if [ -d "$NAME-app" ]; then
	...
	if [ -x "$(command -v node)" ]; then
		...
		# Services
			cd services
				curl -o firebase.js $SOURCE/base/services/firebase-react.js
			cd ..
		# Utils
			cd utils
				curl -o conecction.js $SOURCE/base/utils/conecction-react.js
			cd ..
		# Main
			rm -rf index.js && rm -rf App.js
			curl -o index.jsx $SOURCE/base/index.jsx
